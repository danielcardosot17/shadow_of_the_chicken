...
public class Boss_Neck : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // animator.SetInteger("Boss_Neck_State",state);
    ...
    public void Die(){
        ...
        this.tag = "DeadBoss";
        var impactGenerators = this.gameObject.GetComponentsInChildren<PeckImpactGenerator>().ToArray<PeckImpactGenerator>();
        foreach(PeckImpactGenerator impactGenerator in impactGenerators){
