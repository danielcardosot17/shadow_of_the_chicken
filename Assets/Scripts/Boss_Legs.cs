...
public class Boss_Legs : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // animator.SetInteger("Boss_Legs_State",state);
    ...
    public void Die(){
        ...
        this.tag = "DeadBoss";
        var impactGenerators = this.gameObject.GetComponentsInChildren<JumpImpactGenerator>().ToArray<JumpImpactGenerator>();
        foreach(JumpImpactGenerator impactGenerator in impactGenerators){
            impactGenerator.enabled = false;
        }
